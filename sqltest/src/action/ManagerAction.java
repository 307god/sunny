...
public class ManagerAction extends ActionSupport {
    ...
    public String manager() throws Exception {
        List<Administrator> managerList = session.createSQLQuery("SELECT * FROM A").addEntity(Administrator.class).list();
        ActionContext actionContext = ActionContext.getContext();
    ...
    public String updateManager() throws Exception{
        ...
        try{
            ...
            if(actionContext.getParameters().get("new_data") != null)
            {
                Administrator newManager = new Administrator();
                newManager.setA_id(((String[])actionContext.getParameters().get("m_id"))[0]);
                newManager.setA_name(((String[])actionContext.getParameters().get("m_name"))[0]);
                newManager.setA_pwd(((String[])actionContext.getParameters().get("m_pwd"))[0]);
